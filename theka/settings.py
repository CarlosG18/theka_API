"""
Django settings for theka project.
...
WSGI_APPLICATION = 'theka.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Theka API',
    'DESCRIPTION': 'Theka é uma API desenvolvida para gerenciar uma biblioteca digital, servindo como base para o desafio trainee de Front-End da EJECT.',
    'VERSION': '1.0.0',
